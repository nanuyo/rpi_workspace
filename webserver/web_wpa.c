...
void handle_post_request(int client_socket, char *buffer)
{
    ...
    if (json_start != NULL)
    {
        ...
        if (ssid != NULL && password != NULL)
        {
            ...
            FILE *wpa_file = fopen("/etc/wpa_supplicant/wpa_supplicant.conf", "w");
            if (wpa_file == NULL)
            {
                perror("Error creating wpa_supplicant file");
            ...
            // Restart wpa_supplicant service to apply new configuration
